        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p>Club Amper recompensa tus compras con
                beneficios, promociones y premios exclusivos. </p>
            ...
            <div className="footer-links">
              <h5>Empresa</h5>
              <a href="https://ampercompany.com.pe/" target="_blank" rel="noopener noreferrer"> Sitio oficial </a>
              <a href="#">Términos</a>
              <a href="#">Soporte</a>
            </div>
          </div>
          <div className="footer-bottom">
            <span> © 2026 Club Amper — Todos los derechos reservados</span>
          </div>
        </div>
      </footer>
    </>
